...
modules = {
    "mod01_authentication": {
        "endpoints": [
            {"method": "POST", "path": "/api/v1/auth/otp/request", "name": "requestOtp"},
            {"method": "POST", "path": "/api/v1/auth/otp/verify", "name": "verifyOtp"}
        ],
        "entity": "AuthToken",
        "domain": "AuthData"
    },
...
"""
    ...
    suspend fun {name}({req_body}): retrofit2.Response<com.interview.platform.data.remote.dto.{mod_pkg}.{domain_name}ResponseDto>
"""
...
print("Generated Android Integration Layer Phase 1.")
